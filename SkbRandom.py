...
logo = '   \n\n   _____ _    _       _______                   
 ...
 | (___ | | _| |__      | | ___  __ _ _ __ ___  
  \___ \| |/ / '_ \     | |/ _ \/ _` | '_ ` _ \ 
  ____) |   <| |_) |    | |  __/ (_| | | | | | |
 |_____/|_|\_\_.__/     |_|\___|\__,_|_| |_| |_|\n\x1b[1;97m===========================================\n\x1b[1;32mADMIN\x1b[0m ! ALAMIN \x1b[1;91m & \x1b[0m \x1b[1;92mTOOL\x1b[0m ! PAID \x1b[1;91m & \x1b[0m \x1b[1;92mV\x1b[0m = 3\n\x1b[1;97m===========================================    '

def hasil(OK,cp):
        if not len(OK) != 0:
            pass
        if len(cp) != 0:
            print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mSKB_OK.txt' % (H, P, str(len(ok))))
            print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mSKB_CP.txt' % (H, P, str(len(cp))))
            input("\x1b[1;97mPress enter to back SKB Menu ")
            sarfraz()
